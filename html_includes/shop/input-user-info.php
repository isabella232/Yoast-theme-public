...
<fieldset id="edd_checkout_user_info">
	...
	<p id="edd-first-name-wrap">
		...
		<input class="edd-input <?php echo $fn_error_class; ?>" type="text" name="edd_first" id="edd_first" />
	...
	<p id="edd-last-name-wrap">
		...
		<input class="edd-input <?php echo $ln_error_class; ?>" type="text" name="edd_last" id="edd_last" />
	...
	<p class="clear" id="edd-email-wrap">
		...
		<input class="edd-input <?php echo $email_error_class; ?>" type="email" name="edd_email" id="edd_email" />
